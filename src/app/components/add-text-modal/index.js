                ...
                <div class="relative p-4 min-w-[500px] max-h-full">
                    <div class="relative bg-white shadow opacity-90 border-2 border-lime-300 rounded-lg">
                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t ">
                            ...
                            <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center " data-modal-toggle="crud-modal" onClick={onCloseCallback}>
                        ...
                        <form class="p-4 md:p-5">
                            ...
                            <div class="col-span-2">
                                <textarea onChange={(e) => onChangeHandler("lyric", e.target.value)} id="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="nass maine kaati usme dilli nikli" value={currentLyrics.lyric || lyricData.lyric || ""}></textarea>
                            </div>
                            <div class="flex flex-col flex-wrap">
                                ...
                                <div class="flex flex-row mt-4">
                                    ...
                                    <input type="color" id="fontColor" name="fontColor" value={currentLyrics.fontColor || lyricData.fontColor || "#000000"} onChange={(e) => onChangeHandler("fontColor", e.target.value)} />
                                </div>
                                {/* font background color */}
                                <div class="flex flex-row mt-4">
                                    <label class="text-black pr-2" for="backgroundColor">background color</label>
                                    <input type="color" id="backgroundColor" name="backgroundColor" value={currentLyrics.backgroundColor || lyricData.backgroundColor || "#fff"} onChange={(e) => onChangeHandler("backgroundColor", e.target.value)} />
                                </div>
                                ...
                                {/* add button */}
                                <button type="button" onClick={() => addLyricHandler()} class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
